...
map_loop:
    ...
    # THINK: why a0?
    ### YOUR CODE HERE ###
    # because the first argument is stored in a0@20240312
    addi sp, sp, -4
    sw a0, 0(sp)
    lw a0, 0(a0)
...
malloc:
    ...
    jr  ra
# debug.log
# the program can't come to the end because of forgetting to store ra (line41)
# the program can't visit one address because of considering value as address (line69)
